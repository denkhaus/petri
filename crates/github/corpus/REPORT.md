...
171 distinct actions (268 distinct pinned refs).
...
| actions/checkout | `check-dist.yml` | warnings | 9 | — |
| actions/checkout | `codeql-analysis.yml` | warnings | 10 | — |
| actions/checkout | `licensed.yml` | clean | 5 | — |
| actions/checkout | `publish-immutable-actions.yml` | warnings | 4 | — |
| actions/checkout | `test.yml` | out of scope | — | — |
| actions/checkout | `update-main-version.yml` | clean | 6 | — |
| actions/checkout | `update-test-ubuntu-git.yml` | warnings | 9 | — |
| astral-sh/ruff | `build-binaries.yml` | out of scope | — | — |
| astral-sh/ruff | `build-docker.yml` | warnings | 48 | — |
| astral-sh/ruff | `build-wasm.yml` | warnings | 10 | — |
| astral-sh/ruff | `ci.yaml` | out of scope | — | — |
| astral-sh/ruff | `daily_fuzz.yaml` | warnings | 14 | — |
| astral-sh/ruff | `memory_report.yaml` | warnings | 14 | — |
| astral-sh/ruff | `notify-dependents.yml` | warnings | 3 | — |
| astral-sh/ruff | `publish-crates.yml` | warnings | 7 | — |
| astral-sh/ruff | `publish-docs.yml` | warnings | 16 | — |
| astral-sh/ruff | `publish-mirror.yml` | warnings | 5 | — |
| astral-sh/ruff | `publish-playground.yml` | warnings | 20 | — |
| astral-sh/ruff | `publish-pypi.yml` | warnings | 6 | — |
| astral-sh/ruff | `publish-ty-playground.yml` | warnings | 21 | — |
| astral-sh/ruff | `publish-versions.yml` | warnings | 11 | — |
...
| astral-sh/uv | `check-docs.yml` | warnings | 11 | — |
| astral-sh/uv | `check-fmt.yml` | warnings | 15 | — |
| astral-sh/uv | `check-generated-files.yml` | warnings | 13 | — |
| astral-sh/uv | `check-lint.yml` | out of scope | — | — |
| astral-sh/uv | `check-lock.yml` | warnings | 7 | — |
| astral-sh/uv | `check-publish.yml` | warnings | 6 | — |
| astral-sh/uv | `check-release.yml` | clean | 6 | — |
| astral-sh/uv | `check-zizmor.yml` | warnings | 5 | — |
| astral-sh/uv | `ci.yml` | out of scope | — | — |
| astral-sh/uv | `diagnose-workflow-failure.yml` | warnings | 31 | — |
| astral-sh/uv | `fix-bug.yml` | warnings | 48 | — |
| astral-sh/uv | `issue-triage.yml` | warnings | 156 | — |
| astral-sh/uv | `plan.yml` | warnings | 5 | — |
| astral-sh/uv | `promote-pull-request.yml` | warnings | 28 | — |
| astral-sh/uv | `publish-crates.yml` | warnings | 7 | — |
...
| astral-sh/uv | `publish-versions.yml` | warnings | 11 | — |
| astral-sh/uv | `pull-request-conflicts.yml` | warnings | 47 | — |
| astral-sh/uv | `pull-request-labels.yml` | warnings | 34 | — |
| astral-sh/uv | `pull-request-security-review.yml` | warnings | 39 | — |
| astral-sh/uv | `rebase-conflicted-pull-request.yml` | warnings | 37 | — |
| astral-sh/uv | `release-prepare.yml` | warnings | 32 | — |
| astral-sh/uv | `release.yml` | out of scope | — | — |
| astral-sh/uv | `reproduce-bug.yml` | warnings | 66 | — |
| astral-sh/uv | `sync-python-releases.yml` | warnings | 13 | — |
...
| astral-sh/uv | `update-issue-context.yml` | warnings | 32 | — |
| astral-sh/uv | `update-pull-request-parent.yml` | warnings | 5 | — |
| cli/cli | `agentics-maintenance.yml` | warnings | 94 | — |
| cli/cli | `bump-go.yml` | warnings | 6 | — |
| cli/cli | `codeql.yml` | warnings | 12 | — |
| cli/cli | `copilot-setup-steps.yml` | warnings | 5 | — |
| cli/cli | `dependabot-triage.lock.yml` | warnings | 127 | — |
| cli/cli | `deployment.yml` | out of scope | — | — |
| cli/cli | `go.yml` | out of scope | — | — |
| cli/cli | `govulncheck.yml` | warnings | 8 | — |
| cli/cli | `issue-triage.lock.yml` | warnings | 123 | — |
| cli/cli | `lint.yml` | warnings | 15 | — |
...
| django/django | `coverage_tests.yml` | warnings | 12 | — |
| django/django | `docs.yml` | warnings | 10 | — |
| django/django | `labels.yml` | warnings | 3 | — |
| django/django | `linters.yml` | warnings | 30 | — |
| django/django | `new_contributor_pr.yml` | warnings | 3 | — |
| django/django | `playwright.yml` | warnings | 21 | — |
| django/django | `postgis.yml` | warnings | 11 | — |
| django/django | `python_matrix.yml` | warnings | 13 | — |
| django/django | `schedule_tests.yml` | out of scope | — | — |
| django/django | `schedules.yml` | warnings | 3 | — |
| django/django | `screenshots.yml` | warnings | 16 | — |
| django/django | `tests.yml` | out of scope | — | — |
| facebook/react | `compiler_discord_notify.yml` | warnings | 13 | — |
| facebook/react | `compiler_playground.yml` | warnings | 16 | — |
| facebook/react | `compiler_prereleases.yml` | warnings | 10 | — |
| facebook/react | `compiler_prereleases_manual.yml` | warnings | 13 | — |
| facebook/react | `compiler_prereleases_nightly.yml` | warnings | 13 | — |
| facebook/react | `compiler_rust.yml` | warnings | 29 | — |
...
| facebook/react | `runtime_fuzz_tests.yml` | warnings | 7 | — |
| facebook/react | `runtime_release_from_ci.yml` | warnings | 25 | — |
| facebook/react | `runtime_sizebot_comment.yml` | warnings | 9 | — |
...
| facebook/react | `shared_lint.yml` | warnings | 40 | — |
...
| hashicorp/terraform | `checks.yml` | warnings | 38 | — |
| hashicorp/terraform | `enforce-changelog.yml` | warnings | 6 | — |
| hashicorp/terraform | `equivalence-test-diff.yml` | warnings | 11 | — |
...
| nodejs/node | `build-tarball.yml` | warnings | 20 | — |
| nodejs/node | `close-stalled.yml` | warnings | 3 | — |
| nodejs/node | `codeql.yml` | warnings | 8 | — |
| nodejs/node | `comment-labeled.yml` | warnings | 9 | — |
| nodejs/node | `commit-lint.yml` | warnings | 8 | — |
| nodejs/node | `commit-queue.yml` | warnings | 13 | — |
| nodejs/node | `coverage-linux-without-intl.yml` | warnings | 23 | — |
| nodejs/node | `coverage-linux.yml` | warnings | 23 | — |
...
| nodejs/node | `daily.yml` | warnings | 6 | — |
| nodejs/node | `doc.yml` | warnings | 8 | — |
| nodejs/node | `find-inactive-collaborators.yml` | warnings | 7 | — |
| nodejs/node | `find-inactive-tsc.yml` | warnings | 9 | — |
| nodejs/node | `label-flaky-test-issue.yml` | warnings | 4 | — |
| nodejs/node | `label-pr.yml` | warnings | 3 | — |
| nodejs/node | `license-builder.yml` | warnings | 5 | — |
| nodejs/node | `lint-release-proposal.yml` | warnings | 8 | — |
| nodejs/node | `linters.yml` | warnings | 63 | — |
...
| nodejs/node | `scorecard.yml` | warnings | 10 | — |
| nodejs/node | `stale.yml` | warnings | 3 | — |
| nodejs/node | `stress-test.yml` | out of scope | — | — |
| nodejs/node | `test-internet.yml` | warnings | 10 | — |
...
| nodejs/node | `timezone-update.yml` | warnings | 11 | — |
| nodejs/node | `tools.yml` | warnings | 9 | — |
| nodejs/node | `update-openssl.yml` | warnings | 7 | — |
| nodejs/node | `update-v8.yml` | warnings | 11 | — |
| nodejs/node | `update-wpt.yml` | warnings | 10 | — |
| ohmyzsh/ohmyzsh | `dependencies.yml` | warnings | 11 | — |
...
| pola-rs/polars | `docs-rust.yml` | warnings | 10 | — |
| pola-rs/polars | `issue-labeler.yml` | warnings | 3 | — |
| pola-rs/polars | `lint-global.yml` | warnings | 9 | — |
| pola-rs/polars | `lint-python.yml` | warnings | 16 | — |
| pola-rs/polars | `lint-rust.yml` | warnings | 33 | — |
...
| pola-rs/polars | `test-bytecode-parser.yml` | warnings | 7 | — |
| pola-rs/polars | `test-coverage.yml` | out of scope | — | — |
| pola-rs/polars | `test-pyodide.yml` | warnings | 7 | — |
...
| prometheus/prometheus | `buf-lint.yml` | warnings | 6 | — |
| prometheus/prometheus | `buf.yml` | warnings | 7 | — |
| prometheus/prometheus | `check_release_notes.yml` | warnings | 4 | — |
| prometheus/prometheus | `ci.yml` | out of scope | — | — |
| prometheus/prometheus | `codeql-analysis.yml` | warnings | 8 | — |
| prometheus/prometheus | `container_description.yml` | warnings | 11 | — |
| prometheus/prometheus | `fuzzing.yml` | warnings | 11 | — |
...
| prometheus/prometheus | `scorecards.yml` | warnings | 7 | — |
...
| python/cpython | `lint.yml` | warnings | 5 | — |
| python/cpython | `mypy.yml` | warnings | 8 | — |
| python/cpython | `new-bugs-announce-notifier.yml` | warnings | 6 | — |
| python/cpython | `require-pr-label.yml` | warnings | 8 | — |
| python/cpython | `reusable-check-c-api-docs.yml` | warnings | 6 | — |
...
| python/cpython | `reusable-docs.yml` | warnings | 50 | — |
| python/cpython | `reusable-emscripten.yml` | warnings | 21 | — |
| python/cpython | `reusable-install.yml` | warnings | 12 | — |
| python/cpython | `reusable-macos.yml` | callee only | — | — |
| python/cpython | `reusable-san.yml` | warnings | 18 | — |
| python/cpython | `reusable-ubuntu.yml` | callee only | — | — |
| python/cpython | `reusable-wasi.yml` | warnings | 16 | — |
...
| python/cpython | `verify-ensurepip-wheels.yml` | warnings | 6 | — |
| python/cpython | `verify-expat.yml` | warnings | 4 | — |
| rails/rails | `check-markdown-api.yml` | warnings | 5 | — |
| rails/rails | `devcontainer-shellcheck.yml` | warnings | 4 | — |
| rails/rails | `devcontainer-smoke-test.yml` | warnings | 22 | — |
| rails/rails | `labeler.yml` | warnings | 3 | — |
| rails/rails | `more-info-needed.yml` | warnings | 3 | — |
| rails/rails | `rail_inspector.yml` | warnings | 6 | — |
| rails/rails | `rails-new-docker.yml` | warnings | 12 | — |
...
| tokio-rs/tokio | `audit.yml` | warnings | 4 | — |
| tokio-rs/tokio | `ci.yml` | out of scope | — | — |
| tokio-rs/tokio | `labeler.yml` | warnings | 3 | — |
| tokio-rs/tokio | `loom.yml` | warnings | 114 | — |
| tokio-rs/tokio | `pr-audit.yml` | warnings | 4 | — |
| tokio-rs/tokio | `stress-test.yml` | warnings | 22 | — |
| tokio-rs/tokio | `uring-kernel-version-test.yml` | clean | 10 | — |
...
| vercel/next.js | `issue_wrong_template.yml` | clean | 7 | — |
| vercel/next.js | `popular.yml` | clean | 9 | — |
| vercel/next.js | `pr_ci_comment.yml` | warnings | 5 | — |
...
| vercel/next.js | `test_e2e_project_reset_cron.yml` | clean | 8 | — |
| vercel/next.js | `test_examples.yml` | clean | 10 | — |
...
| vercel/next.js | `upload-tests-manifest.yml` | clean | 8 | — |
